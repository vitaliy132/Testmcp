  ...
  return (
    <section className="overflow-hidden pb-8 lg:pb-12" aria-label="Life in the studio">
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-10 bg-gradient-to-r from-white to-transparent dark:from-[#121212] sm:w-16" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-10 bg-gradient-to-l from-white to-transparent dark:from-[#121212] sm:w-16" />
